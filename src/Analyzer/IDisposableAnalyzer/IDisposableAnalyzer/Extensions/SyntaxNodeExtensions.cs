    ...
    internal static class SyntaxNodeExtensions
    {
        ...
        public static bool IsPartIfArrayInitializerThatIsPartOfObjectCreation(this SyntaxNode node)
        {
            return node?.Parent is InitializerExpressionSyntax
                   && (node.Parent?.Parent is ImplicitArrayCreationExpressionSyntax ||
                       node.Parent?.Parent is ArrayCreationExpressionSyntax)
        ...
        /// <returns></returns>
        public static bool IsDisposedInDisposingMethod(this SyntaxNode nodeInClass, string nameOfVariable,
        ...
        public static bool ContainsDisposeCallFor(this SyntaxNode node, string name, SemanticModel semanticModel,
        ...
        public static bool TryFindContainingParenthesizedLambda(this SyntaxNode node,
            out ParenthesizedLambdaExpressionSyntax method)
        {
