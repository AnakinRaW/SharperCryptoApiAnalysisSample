    ...
    internal class DefaultConfiguration : IConfiguration
    {
        public DefaultConfiguration()
        {
            ...
            TrackingMethods = new Dictionary<string, IReadOnlyCollection<MethodCall>>
            {
                ...
                {
                    new MethodCall("Matches",
                        new[]
                        {
                            "FakeItEasy.IArgumentConstraintManager<T>",
                ...
                ["FakeItEasy.IArgumentConstraintManager"] = new List<MethodCall>()
                {
                    new MethodCall("Matches",
                        new[]
                        {
                            "FakeItEasy.IArgumentConstraintManager<T>",
                            "System.Linq.Expressions.Expression<System.Func<T, bool>>",
                            "System.Action<FakeItEasy.IOutputWriter>"
                        }, true)
                },
            ...
            TrackingFactoryMethods = new Dictionary<string, IReadOnlyCollection<MethodCall>>
            {
                ["FakeItEasy.A"] = new List<MethodCall>
                {
                    ...
                    new MethodCall("CollectionOfFake",
                        new[] {"Int32", "System.Action<FakeItEasy.Creation.IFakeOptions<T>>"}, true),
