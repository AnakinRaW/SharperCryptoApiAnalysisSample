...
{
    [TestFixture]
    internal class If_analyser_runs_on_an_ObjectCreation_in_SimpleLambdaExpression : DisposeableFixerAnalyzerSpec
    {
...
namespace GivenToNonDisposedTrackingInstance {
	internal class Program {
            ...
            {
                Func<int,MemoryStream> create = i => new MemoryStream();
            }
        }
    }
}";
