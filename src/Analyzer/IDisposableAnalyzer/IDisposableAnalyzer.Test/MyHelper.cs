...
using IDisposableAnalyzer.Test.Helpers;
...
namespace IDisposableAnalyzer.Test
{
    public class MyHelper
    {
        ...
        private static readonly MetadataReference SystemDataReference =
        ...
        private static Document[] GetDocumentFrom(string source)
        {
